...
public:
    ...
    float getGoalAngle( int _id , point<float> goalCenter) const;
...
//protected:
    ...
    sock::sock      sockClient; // Socket to connect to the client.
    sock::sock      sockServer; // Socket to accept the client socket.
...
//------------------------------------------------------------------------------
class clientEnvironm : public environm {
...
public:
    ...
    bool connect( char *_address, int _port, int _portServer  );
